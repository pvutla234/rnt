      ...
      ListHeaderComponent={
        <View>
          ...
          <TouchableOpacity
            ...
            className='flex-row items-center bg-white mx-5 rounded-2xl px-4 py-3 gap-3 mb-6'
            style={{
              elevation: 2,
              shadowColor: "#000",
              ...
              <TouchableOpacity onPress={() => router.push("/(root)/(tabs)/search?openFilters=true")} 
                className='w-8 h-8 p-2 bg-blue-600 rounded-xl items-center justify-center'>
